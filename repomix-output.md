...
<file path="package.json">
{
  ...
  "scripts": {
    ...
    "build:ui": "vite build",
    "dev:ui": "vite",
    "dev": "nodemon --watch src/server --ext ts --exec \"pnpm run build && ./ragemp-server.exe\""
  },
  "keywords": [],
  "author": "",
  "license": "ISC",
...
<file path="src/client/@types/index.d.ts">
declare global {
  interface PlayerMp {
...
<file path="src/client/controllers/CameraManager.ts">
...
<file path="src/client/controllers/CharacterController.ts">
...
<file path="src/client/controllers/NotificationManager.ts">
...
<file path="src/client/controllers/UIManager.ts">
/**
...
<file path="src/client/globals.d.ts">
...
<file path="src/client/noclip.ts">
class NoClipManager {
...
<file path="src/client/tsconfig.json">
{
...
<file path="src/server/@types/index.d.ts">
declare global {
  interface PlayerMp {
    customProperty: number;
...
<file path="src/server/commands/admin/AdminChat.ts">
...
<file path="src/server/commands/admin/Announce.ts">
import { register } from "../CommandRegistry";
...
<file path="src/server/commands/admin/Fix.ts">
import { register } from "../CommandRegistry";
import { AdminLevel, Theme } from "../../config/AdminLevels";
...
<file path="src/server/commands/admin/Heal.ts">
import { register } from "../CommandRegistry";
import { AdminLevel, Theme } from "../../config/AdminLevels";
...
<file path="src/server/commands/admin/Money.ts">
import { register } from "../CommandRegistry";
import { AdminLevel, Theme } from "../../config/AdminLevels";
import { PlayerUtils } from "../../utils/PlayerUtils";
...
<file path="src/server/commands/admin/NoClip.ts">
import { register } from "../CommandRegistry";
import { AdminLevel, Theme } from "../../config/AdminLevels";
...
<file path="src/server/commands/admin/SetAdmin.ts">
import { register } from "../CommandRegistry";
import { AdminLevel, Theme } from "../../config/AdminLevels";
...
<file path="src/server/commands/admin/StopServer.ts">
import { register } from "../CommandRegistry";
import { AdminLevel, Theme } from "../../config/AdminLevels";
...
<file path="src/server/commands/admin/Tp.ts">
import { register } from "../CommandRegistry";
import { AdminLevel, Theme } from "../../config/AdminLevels";
...
<file path="src/server/commands/admin/Veh.ts">
import { register } from "../CommandRegistry";
import { AdminLevel, Theme } from "../../config/AdminLevels";
...
<file path="src/server/commands/chat/RoleplayCommands.ts">
import { register } from "../CommandRegistry";
...
<file path="src/server/commands/CommandManager.ts">
import fs from "fs";
...
<file path="src/server/commands/CommandRegistry.ts">
...
<file path="src/server/commands/general/Creator.ts">
import { register } from "../CommandRegistry";
import { Theme } from "../../config/AdminLevels";
...
<file path="src/server/commands/general/Help.ts">
...
<file path="src/server/commands/general/Stats.ts">
import { register } from "../CommandRegistry";
...
<file path="src/server/config/AdminLevels.ts">
...
<file path="src/server/database/entities/Character.ts">
import { 
    Entity, 
...
<file path="src/server/database/entities/User.ts">
...
<file path="src/server/events/AuthHandlers.ts">
import { AuthService } from "../services/AuthService";
...
<file path="src/server/events/CharacterHandlers.ts">
...
<file path="src/server/events/PlayerEvents.ts">
import { Logger } from "../utils/Logger";
import { User } from "../database/entities/User";
import { PlayerUtils } from "../utils/PlayerUtils";
...
<file path="src/server/globals.d.ts">
...
<file path="src/server/managers/CharacterManager.ts">
import {
  Character,
  CharacterAppearance,
  CharacterClothes,
...
<file path="src/server/services/AuthService.ts">
import bcrypt from "bcryptjs";
import { User } from "../database/entities/User";
import { Logger } from "../utils/Logger";
import { PlayerUtils } from "../utils/PlayerUtils";
...
<file path="src/server/services/UserService.ts">
import { User } from "../database/entities/User";
...
<file path="src/server/tsconfig.json">
{
  "extends": "../../tsconfig.json",
  "compilerOptions": {
...
<file path="src/server/utils/HUDUtils.ts">
import { PlayerUtils } from "../utils/PlayerUtils";
...
<file path="src/server/utils/Logger.ts">
import fs from "fs";
import path from "path";
...
<file path="src/server/utils/PlayerUtils.ts">
import { User } from "../database/entities/User";
...
<file path="src/web/@types/intex.d.ts">
declare global {
  interface PlayerMp {
    customProperty: number;
...
<file path="src/web/components/DevTools.tsx">
...
<file path="src/web/components/HUD.tsx">
...
<file path="src/web/components/ui/button.tsx">
...
<file path="src/web/components/ui/input.tsx">
import * as React from "react"
import { cn } from "@/lib/utils"
...
<file path="src/web/components/ui/NotificationSystem.tsx">
...
<file path="src/web/lib/utils.ts">
...
<file path="src/web/pages/auth/Login.tsx">
import React, { useState } from "react";
import EventManager from "../../utils/EventManager";
...
<file path="src/web/pages/char-creator/CharacterCreator.tsx">
...
<file path="src/web/pages/GameInterface.tsx">
import React from 'react';
...
const GameInterface: React.FC = () => {
    return (
        <div className="w-full h-full relative pointer-events-none">
            ...
            {/* Aici vor veni Speedometer, Notificări, etc. */}
        </div>
    );
};
...
<file path="src/web/tsconfig.json">
{
  "extends": "../../tsconfig.json",
  "compilerOptions": {
...
<file path="src/web/utils/EventManager.ts">
...
class EventManager {
    ...
    public triggerServer(eventName: string, ...args: any[]): void {
        if (window.mp && window.mp.trigger) {
            try {
                this.log('info', `Triggering: ${eventName} | Args: ${JSON.stringify(args)}`);
